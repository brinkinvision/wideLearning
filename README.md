<img src="images/logo/widelearning_logo.png" align="center" alt="widelearning_logo" />
<div align="center">
...
[**`Инструкция`**](/docs/tutorial) | [**`Gitlab`**](https://gitlab.com/brinkinvision/widelearning) | [**`GitFlic`**](https://gitflic.ru/project/brinkinvision/wide-learning) | [**`PyPI`**](https://pypi.org/project/widelearning/) | [**`Пример новых вариантов использования`**](/docs/learning_on_mistakes)

# Оглавление

* [Публикации](#публикации)
* [Минимальные требования к аппаратной части](#минимальные-требования-к-аппаратной-части)
...
* [Шаблоны вызова функций сверточного слоя](#шаблоны-вызова-функций-сверточного-слоя)
* [Шаблоны вызова функций полносвязного слоя](#шаблоны-вызова-функций-полносвязного-слоя)
...
<details><summary>Сверточный слой</summary> 
...
<details><summary>Полносвязный слой</summary>
